...
주소는 `https://exp.agd-offer.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://exp.agd-offer.co.kr/blog/agoda-coupon/ |
...
- 포인트 색: **#0E86D4** (sky-deep) — `blog.css` 맨 위 `--blog-point`
